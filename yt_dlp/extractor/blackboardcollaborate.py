...
class BlackboardCollaborateUltraSingleCourseIE(InfoExtractor):
    ...
    _TESTS = [  # All Require a login
        ...
        {
            'url': 'https://online.uwl.ac.uk/blackboard/execute/courseMain?course_id=_1445',
            'only_matching': True,
        },
        {
        ...
        {
            'url': 'https://nestor.rug.nl/ultra/courses/_404619_1/cl/outline',
            'only_matching': True,
        },
    ]
